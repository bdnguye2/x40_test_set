...
def writedef(hfound,nshls,definp,method,struct,scfparams,ghosts,defcoo):
  filinp = open(definp,'w')
  filinp.write('\n')
  filinp.write('\n')
  filinp.write('a ' +defcoo+ '\n')
#  filinp.write('ired\n')
  filinp.write('frag\n')
  filinp.write('on\n')
  for ientry in range(struct['totatms']/19+1):
    filinp.write('\n')
  filinp.write('x\n')
  filinp.write('x\n')
  filinp.write('1\n')
  filinp.write(str(struct['totatms'] - struct['fragBatms'])+'\n')
  filinp.write('1\n')
  filinp.write('x\n')
  filinp.write(str(struct['totatms'] - struct['fragBatms'] + 1)+'\n')
  filinp.write(str(struct['totatms'])+'\n')
  filinp.write('2\n')
  filinp.write('sym\n')
  filinp.write('cha\n')
  filinp.write(str(struct['fragA'])+'\n')
  filinp.write(str(struct['fragB'])+'\n')
  filinp.write('*\n')
...
ghosts=[]
nshls=1
writedef(hfound,nshls,definp,method,struct,scfparams,ghosts,defcoo) 
